...
// Check local storage for best score, set bestscore value
...
function createEquations() {
  ...
  for (let i = 0; i < wrongEquations; i++) {
    ...
    const formatChoice = Math.floor(Math.random() * wrongFormat.length)
